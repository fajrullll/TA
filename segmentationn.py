...
def cek_tiang_vertikal_atas(skel, start_yx, height_thresh=15, max_width_deviation=5):
    ...
    dari titik start_yx. Berguna untuk membedakan Lam (punya tiang) vs Mim (tidak).
    """
    sy, sx = start_yx
    h, w = skel.shape
    stack = [(sy, sx)]
...
ax.set_title("Visualisasi Perpotongan Final (Sin Utuh, Lam-Nun Terpisah)")
ax.axis('off')
plt.show()
